...
import { ALLOWED_ROLES, DEFAULT_ROLES } from '../config/global.config.js';
...
const userSchema = new Schema({
    ...
    roles:/*["registered", "cliente"]*/{
        type: [String],
        required: true,
        enum: ALLOWED_ROLES, // Cada elemento del array debe ser un rol válido
